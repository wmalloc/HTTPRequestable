...
public protocol HTTPInterceptor: Sendable {
  ...
  /// - Returns: An `HTTPResponseEnvelope` representing the response for the request.
  /// - Throws: Propagates any error thrown by the next interceptor or the underlying network operation.
  typealias NextHandler = (_ request: HTTPRequest, _ delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
  ...
  /**
   ...
   - Parameters:
     ...
     - delegate: An optional `URLSessionTaskDelegate` that allows customization of the request and response behavior. If not provided, a default delegate will be used.
   - Returns: An `HTTPResponseEnvelope` representing the network response or an interceptor-provided response.
   ...
   */
  func intercept(_ request: HTTPRequest, next: @escaping NextHandler, delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
}
