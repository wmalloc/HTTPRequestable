...
public protocol HTTPTransportable {
  ...
  /// - Returns: A value of type `HTTPResponseEnvelope`, which encapsulates the status code,
  ...
  func performRequest(_ request: HTTPRequest, httpBody body: Data?, retryPolicy: RetryPolicy?, delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
  ...
  /// - Returns: An `HTTPResponseEnvelope` object containing the data received from the server in response to the request.
  ...
  /// - Note: The `HTTPResponseEnvelope` type can be defined by your application to encapsulate the response data and related information.
  ///
  /// - SeeAlso: `HTTPRequestConfigurable`, `HTTPResponseEnvelope`, `URLSessionTaskDelegate`
  func performRequest(_ request: some HTTPRequestConfigurable, retryPolicy: RetryPolicy?, delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
  ...
  func upload(for request: some HTTPRequestConvertible, from bodyData: Data, delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
  ...
  /// - Note: The `HTTPResponseEnvelope` type can be defined by your application to encapsulate the response data and related information.
  ///
  /// - SeeAlso: `HTTPRequestConvertible`, `HTTPResponseEnvelope`, `URLSessionTaskDelegate`
  func upload(for request: some HTTPRequestConvertible, fromFile fileURL: URL, delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
  ...
  ///
  /// - SeeAlso: `HTTPRequestConfigurable`, `HTTPResponseEnvelope`, `URLSessionTaskDelegate`
  func upload(for request: some HTTPRequestConfigurable, multipartForm: MultipartForm, delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
  ...
  func download(for request: some HTTPRequestConvertible, delegate: (any URLSessionTaskDelegate)?) async throws -> HTTPResponseEnvelope
