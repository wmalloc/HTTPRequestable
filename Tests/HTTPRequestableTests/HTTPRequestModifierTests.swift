...
struct HTTPRequestHeadersModifierTests {
  ...
  func initWithHTTPFields() throws {
  ...
  func initWithHTTPFieldsReplaceExisting() throws {
  ...
  func initWithInvalidHeaders() throws {
    let headers = [
      "User-Agent": "TestAgent/1.0",
  ...
  func initWithArrayLiteral() throws {
  ...
  func initWithDictionaryLiteral() throws {
    let modifier: HTTPRequestHeadersModifier = [
      "User-Agent": "TestAgent/1.0",
      "Accept": "application/json"
    ]
